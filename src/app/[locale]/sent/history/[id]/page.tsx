...
function HistoryDetailPage() {
  const t = useTranslations('SentHistoryDetail');
          ...
          <Card className="border-0 shadow-xl shadow-slate-200/50">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">{t('parseResult')}</CardTitle>
                  <CardDescription className="text-xs">{t('parseResultDesc')}</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 shadow-xl shadow-slate-200/50">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">{t('suggestedContent')}</CardTitle>
          ...
          <Card className="border-0 shadow-xl shadow-slate-200/50">
            <CardHeader className="pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg">{t('chineseReference')}</CardTitle>
                  <CardDescription className="text-xs">{t('chineseReferenceDesc')}</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
