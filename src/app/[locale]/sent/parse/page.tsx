...
function PastePageContent() {
  const t = useTranslations('SentParse');
          ...
          <div className="max-w-3xl mx-auto mt-8">
            <div className="bg-white rounded-2xl border border-slate-200 p-12 shadow-lg">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-slate-600">{t('loadingHistory')}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <DialogHeader>
            ...
            <DialogDescription className="pt-4 text-slate-700">
              <span className="block mb-4">
                {t('duplicateDesc', { id: duplicateInfo?.postcardId })}
              </span>
              <span className="block bg-slate-50 p-3 rounded-lg text-center font-medium text-slate-800 mb-4">
                {t('duplicateTime', { time: duplicateInfo?.formattedTime })}
              </span>
              <span className="block mb-4">{t('duplicateRead')}</span>
              <span className="block text-sm text-slate-500">
                {t('duplicateOverwriteHint')}
              </span>
            </DialogDescription>
          </DialogHeader>
