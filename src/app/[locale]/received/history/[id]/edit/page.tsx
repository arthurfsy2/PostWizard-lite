...
export default function EditCardPage() {
  ...
  const t = useTranslations('ReceivedHistoryEdit');
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-gray-900">{t('adjustImage')}</h3>
                  </div>
                  <button
